...
[![CLI: pig v0.2.2](https://img.shields.io/badge/pig-v0.2.2-slategray?style=flat&logo=cilium&logoColor=white)](https://github.com/pgsty/pig)
...
Provide 404 available [Extensions](https://ext.pigsty.io/#/list) as [RPM](https://ext.pigsty.io/#/rpm) / [DEB](https://ext.pigsty.io/#/deb) for PostgreSQL **13** - **17** in addition to the official PGDG repo.
