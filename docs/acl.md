...
|:--:|---------|:-------:|:----:|-----------------|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 1.0.4 | **<span class="tcblue">BSD-2</span>** | **<span class="tcwarn">PIGSTY</span>** | `acl_$v*` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |
| [DEB](/deb) | 1.0.4 | **<span class="tcblue">BSD-2</span>** | **<span class="tcwarn">PIGSTY</span>** | `postgresql-$v-acl` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |



Install `acl` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 |
|:------------:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `acl_17*` | `acl_16*` | `acl_15*` | `acl_14*` | `acl_13*` |
| `el9` | `acl_17*` | `acl_16*` | `acl_15*` | `acl_14*` | `acl_13*` |
| `d12` | `postgresql-17-acl` | `postgresql-16-acl` | `postgresql-15-acl` | `postgresql-14-acl` | `postgresql-13-acl` |
| `u22` | `postgresql-17-acl` | `postgresql-16-acl` | `postgresql-15-acl` | `postgresql-14-acl` | `postgresql-13-acl` |
| `u24` | `postgresql-17-acl` | `postgresql-16-acl` | `postgresql-15-acl` | `postgresql-14-acl` | `postgresql-13-acl` |
