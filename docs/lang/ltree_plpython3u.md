...
|:--:|-----------|:-------:|:-------:|:---:|:---:|:------:|:-------:|:-----:|:-------:|:-------:|----------|
| 2292 | [ltree_plpython3u](https://www.postgresql.org/docs/current/plpython.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** |  | <span class="tcwarn">✘</span> | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> | <span class="tcblue">✔</span> | [`ltree`](/type/ltree), [`plpython3u`](/lang/plpython3u) |
...
```sql
CREATE EXTENSION ltree_plpython3uCASCADE;
```
