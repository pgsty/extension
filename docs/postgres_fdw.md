...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [postgres_fdw](https://www.postgresql.org/docs/current/postgres-fdw.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `postgres_fdw` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add postgres_fdw
```


Install `postgres_fdw` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
