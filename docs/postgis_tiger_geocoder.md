...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [postgis_tiger_geocoder](https://git.osgeo.org/gitea/postgis/postgis) | 3.5.2 | **<span class="tcwarn">GPLv2</span>** | **<span class="tccyan">PGDG</span>** | **<span class="tccyan">PGDG</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [postgis](/postgis_tiger_geocoder) |  | `tiger` | [`postgis`](postgis), [`fuzzystrmatch`](fuzzystrmatch) |  |
...
Install `postgis_tiger_geocoder` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add postgis_tiger_geocoder
```
