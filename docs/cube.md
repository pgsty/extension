...
|-----------|:-------:|:-------:|:---:|:---:|:--:|:-----:|:------:|:-------:|:-----:|:-------:|:-------:|
| [cube](https://www.postgresql.org/docs/current/cube.html) | 1.5 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |  |  | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> |  |



| Package | Tags | Schemas | Requires | Required by | Comment | Description |
|---------|------|---------|----------|-------------|:-------:|-------------|
| [cube](/cube) |  |  |  | [`earthdistance`](/earthdistance), [`pg4ml`](/pg4ml) |  | data type for multidimensional cubes |
...
Install `cube` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["cube"]}'
```


Install `cube` [RPM](/rpm) from the **<span class="tcblue">CONTRIB</span>** **YUM** repo:
...
Install `cube` [DEB](/deb) from the **<span class="tcblue">CONTRIB</span>** **APT** repo:
