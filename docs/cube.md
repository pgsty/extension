...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [cube](https://www.postgresql.org/docs/current/cube.html) | 1.5 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [cube](/cube) |  |  |  | [`earthdistance`](/earthdistance), [`pg4ml`](/pg4ml) |
...
Install `cube` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
