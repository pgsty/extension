...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [tablefunc](https://www.postgresql.org/docs/current/tablefunc.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [tablefunc](/tablefunc) |  |  |  | [`pg4ml`](/pg4ml) |
...
Install `tablefunc` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add tablefunc
```


Install `tablefunc` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
