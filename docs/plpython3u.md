...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [plpython3u](https://www.postgresql.org/docs/current/plpython.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `plpython3u` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add plpython3u
```
