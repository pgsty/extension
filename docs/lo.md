...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [lo](https://www.postgresql.org/docs/current/lo.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `lo` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `lo` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["lo"]}'
```


Install `lo` [RPM](/rpm) from the **<span class="tcblue">CONTRIB</span>** **YUM** repo:
...
Install `lo` [DEB](/deb) from the **<span class="tcblue">CONTRIB</span>** **APT** repo:
