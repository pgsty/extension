...
> [oid2name](https://www.postgresql.org/docs/current/oid2name.html): utility program that helps administrators to examine the file structure used by PostgreSQL
>
...
|-----------|:-------:|:-------:|:---:|:---:|:--:|:-----:|:------:|:-------:|:-----:|:-------:|:-------:|
| [oid2name](https://www.postgresql.org/docs/current/oid2name.html) | - | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` | **<span class="tcblue">✔</span>** |  | <span class="tcwarn">✘</span> | <span class="tcwarn">✘</span> | <span class="tcwarn">✘</span> |  |
...
Install `oid2name` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["oid2name"]}'
```


Install `oid2name` [RPM](/rpm) from the **<span class="tcblue">CONTRIB</span>** **YUM** repo:
...
Install `oid2name` [DEB](/deb) from the **<span class="tcblue">CONTRIB</span>** **APT** repo:
