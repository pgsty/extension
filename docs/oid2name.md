...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [oid2name](https://www.postgresql.org/docs/current/oid2name.html) | - | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `oid2name` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
