...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pgrowlocks](https://www.postgresql.org/docs/current/pgrowlocks.html) | 1.2 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `pgrowlocks` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pgrowlocks
```


Install `pgrowlocks` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
