...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [xml2](https://www.postgresql.org/docs/current/xml2.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `xml2` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `xml2` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["xml2"]}'
```


Install `xml2` [RPM](/rpm) from the **<span class="tcblue">CONTRIB</span>** **YUM** repo:
...
Install `xml2` [DEB](/deb) from the **<span class="tcblue">CONTRIB</span>** **APT** repo:
