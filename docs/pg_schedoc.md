...
> [pg_schedoc](https://github.com/ZeroGachis/pg_schedoc): 
>
...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pg_schedoc](https://github.com/ZeroGachis/pg_schedoc) | 0.0.1 | **<span class="tcwarn">GPLv3</span>** |  | **<span class="tcwarn">PIGSTY</span>** | `SQL` |
...
|-------|------|---------|----------|-------------|
| [pg_schedoc](/pg_schedoc) |  |  | [`ddl_historization`](ddl_historization) |  |
...
```sql
CREATE EXTENSION pg_schedoc CASCADE;
```
...
Install `pg_schedoc` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pg_schedoc
```
