...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [omnisketch](https://github.com/tvondra/omnisketch) | 1.0.2 | **<span class="tcblue">PostgreSQL</span>** |  | **<span class="tcwarn">PIGSTY</span>** | `C` |



| `Bin` | `LOAD` | `DYLIB` | `DDL` | `TRUST` | `RELOC` |
|:-----:|:------:|:-------:|:-----:|:-------:|:-------:|
|  |  | <span class="tcblue">✔</span> |  |  |  |
...
Install `omnisketch` [DEB](/deb) from the  **APT** repo:

```bash
apt install postgresql-$v-omnisketch;
```
