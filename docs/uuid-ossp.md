...
|---------|------|---------|----------|-------------|:-------:|-------------|
| [uuid-ossp](/uuid-ossp) |  |  |  | [`babelfishpg_tsql`](/babelfishpg_tsql) |  | generate universally unique identifiers (UUIDs) |
...
Install `uuid-ossp` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:
