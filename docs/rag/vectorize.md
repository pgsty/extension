...
|:--:|-----------|:-------:|:-------:|:---:|:---:|:------:|:-------:|:-----:|:-------:|:-------:|----------|
| 1220 | [vectorize](https://github.com/tembo-io/pg_vectorize) | 0.18.3 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** |  | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> | <span class="tcwarn">✘</span> | [`pg_cron`](/time/pg_cron), [`pgmq`](/feat/pgmq), [`vector`](/rag/vector) |
...
```sql
CREATE EXTENSION vectorizeCASCADE;
```
