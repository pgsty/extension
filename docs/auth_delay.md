...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [auth_delay](https://www.postgresql.org/docs/current/auth-delay.html) | - | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `auth_delay` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add auth_delay
```


Install `auth_delay` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
