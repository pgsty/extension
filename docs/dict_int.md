...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [dict_int](https://www.postgresql.org/docs/current/dict-int.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `dict_int` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add dict_int
```


Install `dict_int` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
