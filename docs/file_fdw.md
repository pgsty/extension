...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [file_fdw](https://www.postgresql.org/docs/current/file-fdw.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [file_fdw](/file_fdw) |  |  |  | [`pg_sqlog`](/pg_sqlog) |
...
Install `file_fdw` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add file_fdw
```


Install `file_fdw` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
