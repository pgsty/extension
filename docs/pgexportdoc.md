...
|:--:|-----------|:-------:|:-------:|:---:|:---:|:------:|:-------:|:-----:|:-------:|:-------:|
| 9860 | [pgexportdoc](https://github.com/okbob/pgexportdoc) | 0.1.4 | **<span class="tcblue">BSD-2</span>** | **<span class="tccyan">PGDG</span>** | PGDG |  | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> | <span class="tcwarn">✘</span> |  |
...
|:--:|---------|:-------:|:---:|-------------|:--:|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 0.1.4 | **<span class="tcblue">BSD-2</span>** | **<span class="tccyan">PGDG</span>** | `pgexportdoc_$v*` | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> |  |



Install `pgexportdoc` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["pgexportdoc"]}'
```


Install `pgexportdoc` [RPM](/rpm) from the **<span class="tccyan">PGDG</span>** **YUM** repo:

```bash
dnf install pgexportdoc_17*;
dnf install pgexportdoc_16*;
dnf install pgexportdoc_15*;
dnf install pgexportdoc_14*;
dnf install pgexportdoc_13*;
dnf install pgexportdoc_12*;
```
