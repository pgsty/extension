...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [intagg](https://www.postgresql.org/docs/current/intagg.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `intagg` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `intagg` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["intagg"]}'
```
