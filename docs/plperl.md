...
|-------|------|---------|----------|-------------|
| [plperl](/plperl) |  |  | [`plperl`](plperl) | [`plperl`](/plperl), [`bool_plperl`](/bool_plperl), [`hstore_plperl`](/hstore_plperl), [`jsonb_plperl`](/jsonb_plperl), [`sparql`](/sparql) |
...
Install `plperl` via the [`pig`](https://github.com/pgsty/pig) cli tool:
