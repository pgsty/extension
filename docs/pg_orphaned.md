...
|:--:|---------|:-------:|:----:|-----------------|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | `pg_orphaned_$v*` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |
| [DEB](/deb) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | `postgresql-$v-pg-orphaned` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |



Install `pg_orphaned` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pg_orphaned
```
...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 |
|:------------:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `pg_orphaned_17*` | `pg_orphaned_16*` | `pg_orphaned_15*` | `pg_orphaned_14*` | `pg_orphaned_13*` |
| `el9` | `pg_orphaned_17*` | `pg_orphaned_16*` | `pg_orphaned_15*` | `pg_orphaned_14*` | `pg_orphaned_13*` |
| `d12` | `postgresql-17-pg-orphaned` | `postgresql-16-pg-orphaned` | `postgresql-15-pg-orphaned` | `postgresql-14-pg-orphaned` | `postgresql-13-pg-orphaned` |
| `u22` | `postgresql-17-pg-orphaned` | `postgresql-16-pg-orphaned` | `postgresql-15-pg-orphaned` | `postgresql-14-pg-orphaned` | `postgresql-13-pg-orphaned` |
| `u24` | `postgresql-17-pg-orphaned` | `postgresql-16-pg-orphaned` | `postgresql-15-pg-orphaned` | `postgresql-14-pg-orphaned` | `postgresql-13-pg-orphaned` |
