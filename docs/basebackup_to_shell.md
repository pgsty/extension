...
|:--:|-----------|:-------:|:-------:|:---:|:---:|:------:|:-------:|:-----:|:-------:|:-------:|
| 5950 | [basebackup_to_shell](https://www.postgresql.org/docs/current/basebackup-to-shell.html) | - | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** |  | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> | <span class="tcwarn">✘</span> |  |
...
Install `basebackup_to_shell` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:
