...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [tsm_system_time](https://www.postgresql.org/docs/current/tsm-system-time.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `tsm_system_time` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add tsm_system_time
```


Install `tsm_system_time` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
