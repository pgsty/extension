...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [unaccent](https://www.postgresql.org/docs/current/unaccent.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `unaccent` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add unaccent
```


Install `unaccent` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["unaccent"]}'
```
