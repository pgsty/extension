...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [btree_gin](https://www.postgresql.org/docs/current/btree-gin.html) | 1.3 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `btree_gin` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
