...
|---------|------|---------|----------|-------------|:-------:|-------------|
| [pg_stat_statements](/pg_stat_statements) |  |  |  | [`pg_stat_kcache`](/pg_stat_kcache), [`powa`](/powa) |  | track planning and execution statistics of all SQL statements executed |
...
Install `pg_stat_statements` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:
