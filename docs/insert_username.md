...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [insert_username](https://www.postgresql.org/docs/current/contrib-spi.html#CONTRIB-SPI-INSERT-USERNAME) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `insert_username` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add insert_username
```


Install `insert_username` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
