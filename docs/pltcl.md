...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pltcl](https://www.postgresql.org/docs/current/pltcl.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `pltcl` via the [`pig`](https://github.com/pgsty/pig) cli tool:
