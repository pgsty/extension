...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [hstore_pllua](https://github.com/pllua/pllua) | 2.0.12 | **<span class="tcblue">MIT</span>** |  | **<span class="tccyan">PGDG</span>** | `C` |
...
Install `hstore_pllua` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add hstore_pllua
```
