...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [isn](https://www.postgresql.org/docs/current/isn.html) | 1.2 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `isn` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `isn` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
