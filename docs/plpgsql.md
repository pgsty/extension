...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [plpgsql](https://www.postgresql.org/docs/current/plpgsql.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [plpgsql](/plpgsql) |  |  |  | [`table_version`](/table_version), [`pg4ml`](/pg4ml), [`plpgsql_check`](/plpgsql_check), [`unit`](/unit), [`ddl_historization`](/ddl_historization), [`data_historization`](/data_historization), [`pg_upless`](/pg_upless), [`pg_drop_events`](/pg_drop_events), [`pg_profile`](/pg_profile), [`powa`](/powa) |
...
Install `plpgsql` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `plpgsql` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:

```bash
./pgsql.yml -t pg_extension -e '{"pg_extensions": ["plpgsql"]}'
```


Install `plpgsql` [RPM](/rpm) from the **<span class="tcblue">CONTRIB</span>** **YUM** repo:
...
Install `plpgsql` [DEB](/deb) from the **<span class="tcblue">CONTRIB</span>** **APT** repo:
