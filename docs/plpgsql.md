...
|:--:|-----------|:-------:|:-------:|:---:|:---:|:------:|:-------:|:-----:|:-------:|:-------:|
| 2280 | [plpgsql](https://www.postgresql.org/docs/current/plpgsql.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** |  | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> |  |
...
- **Required By**: [`table_version`](/table_version), [`pg4ml`](/pg4ml), [`plpgsql_check`](/plpgsql_check), [`unit`](/unit), [`pg_profile`](/pg_profile), [`powa`](/powa)
