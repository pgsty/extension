...
|-----------|:-------:|:-------:|:---:|:---:|:--:|:-----:|:------:|:-------:|:-----:|:-------:|:-------:|
| [plpgsql](https://www.postgresql.org/docs/current/plpgsql.html) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |  |  | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | <span class="tcwarn">✘</span> |  |



| Package | Tags | Schemas | Requires | Required by | Comment | Description |
|---------|------|---------|----------|-------------|:-------:|-------------|
| [plpgsql](/plpgsql) |  |  |  | [`table_version`](/table_version), [`pg4ml`](/pg4ml), [`plpgsql_check`](/plpgsql_check), [`unit`](/unit), [`pg_profile`](/pg_profile), [`powa`](/powa) |  | PL/pgSQL procedural language |
...
Install `plpgsql` via [Pigsty](https://pigsty.cc/docs/pgext/usage/install/) playbook:
