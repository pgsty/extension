...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [meta](https://github.com/aquameta/meta) | 0.4.0 | **<span class="tcblue">BSD-2</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `SQL` |
...
|:--:|---------|:-------:|:----:|-----------------|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 0.4.0 | **<span class="tcblue">BSD-2</span>** | **<span class="tcwarn">PIGSTY</span>** | `pg_meta_$v` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |
| [DEB](/deb) | 0.4.0 | **<span class="tcblue">BSD-2</span>** | **<span class="tcwarn">PIGSTY</span>** | `postgresql-$v-pg-meta` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |



Install `meta` via the [`pig`](https://github.com/pgsty/pig) cli tool:
...
Install `pg_meta` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 |
|:------------:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `pg_meta_17` | `pg_meta_16` | `pg_meta_15` | `pg_meta_14` | `pg_meta_13` |
| `el9` | `pg_meta_17` | `pg_meta_16` | `pg_meta_15` | `pg_meta_14` | `pg_meta_13` |
| `d12` | `postgresql-17-pg-meta` | `postgresql-16-pg-meta` | `postgresql-15-pg-meta` | `postgresql-14-pg-meta` | `postgresql-13-pg-meta` |
| `u22` | `postgresql-17-pg-meta` | `postgresql-16-pg-meta` | `postgresql-15-pg-meta` | `postgresql-14-pg-meta` | `postgresql-13-pg-meta` |
| `u24` | `postgresql-17-pg-meta` | `postgresql-16-pg-meta` | `postgresql-15-pg-meta` | `postgresql-14-pg-meta` | `postgresql-13-pg-meta` |
