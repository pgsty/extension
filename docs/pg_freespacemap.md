...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pg_freespacemap](https://www.postgresql.org/docs/current/pgfreespacemap.html) | 1.2 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `pg_freespacemap` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pg_freespacemap
```


Install `pg_freespacemap` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
