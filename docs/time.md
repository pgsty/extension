...
| 1075 | [pg_task](/pg_task) | 1.0.0 | [pg_task](/pg_task) | **<span class="tcblue">MIT</span>** | **<span class="tccyan">PGDG</span>** |  | [LINK](https://github.com/RekGRpth/pg_task) |  | <span class="tcred">❗</span> | <span class="tcblue">✔</span> | <span class="tcblue">✔</span> | execute any sql command at any specific time at background |
...
```yaml
pg17: timescaledb periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_timeseries #pg_task
pg16: timescaledb pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_task
pg15: timescaledb pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_task
pg14: timescaledb pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_task
pg13: pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #timescaledb #pg_task
```
...
pg15: timescaledb pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_task
pg14: timescaledb pg_timeseries periods temporal_tables emaj table_version pg_cron pg_later pg_background #pg_task
pg13: periods temporal_tables emaj table_version pg_cron pg_later pg_background #timescaledb #pg_timeseries #pg_task
```
