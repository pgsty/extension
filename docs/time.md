...
```yaml
pg17: timescaledb pg_timeseries periods table_version pg_cron pg_later pg_background #timescaledb_toolkit #temporal_tables #emaj
...
```yaml
pg17: timescaledb-2-postgresql-17* pg_timeseries_17 periods_17* table_version_17* pg_cron_17* pg_later_17 pg_background_17* #timescaledb-toolkit-postgresql-17 #temporal_tables_17* #e-maj_17*
