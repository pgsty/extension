...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [postgis_raster](https://git.osgeo.org/gitea/postgis/postgis) | 3.5.2 | **<span class="tcwarn">GPLv2</span>** | **<span class="tccyan">PGDG</span>** | **<span class="tccyan">PGDG</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [postgis](/postgis_raster) |  |  | [`postgis`](postgis) | [`h3_postgis`](/h3_postgis) |
...
Install `postgis_raster` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add postgis_raster
```
