...
|:--:|---------|:-------:|:----:|-----------------|:--:|:--:|:--:|:--:|:--:|------------|
| [RPM](/rpm) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | `hunspell_nn_no_$v` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |
| [DEB](/deb) | 1.0 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | `postgresql-$v-hunspell-nn-no` | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** | **<span class="tcwarn">✔</span>** |  |



Install `hunspell_nn_no` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add hunspell_nn_no
```
...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 |
|:------------:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `hunspell_nn_no_17` | `hunspell_nn_no_16` | `hunspell_nn_no_15` | `hunspell_nn_no_14` | `hunspell_nn_no_13` |
| `el9` | `hunspell_nn_no_17` | `hunspell_nn_no_16` | `hunspell_nn_no_15` | `hunspell_nn_no_14` | `hunspell_nn_no_13` |
| `d12` | `postgresql-17-hunspell-nn-no` | `postgresql-16-hunspell-nn-no` | `postgresql-15-hunspell-nn-no` | `postgresql-14-hunspell-nn-no` | `postgresql-13-hunspell-nn-no` |
| `u22` | `postgresql-17-hunspell-nn-no` | `postgresql-16-hunspell-nn-no` | `postgresql-15-hunspell-nn-no` | `postgresql-14-hunspell-nn-no` | `postgresql-13-hunspell-nn-no` |
| `u24` | `postgresql-17-hunspell-nn-no` | `postgresql-16-hunspell-nn-no` | `postgresql-15-hunspell-nn-no` | `postgresql-14-hunspell-nn-no` | `postgresql-13-hunspell-nn-no` |
