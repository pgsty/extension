...
```bash
yum install pg_rational_17*;
yum install pg_rational_16*;
yum install pg_rational_15*;
yum install pg_rational_14*;
yum install pg_rational_13*;
yum install pg_rational_12*;
```
