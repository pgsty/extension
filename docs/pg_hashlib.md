...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [pg_hashlib](https://github.com/markokr/pghashlib) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcwarn">PIGSTY</span>** | **<span class="tcwarn">PIGSTY</span>** | `C` |
...
Install `pg_hashlib` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add pg_hashlib
```
