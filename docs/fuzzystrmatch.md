...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [fuzzystrmatch](https://www.postgresql.org/docs/current/fuzzystrmatch.html) | 1.2 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
|-------|------|---------|----------|-------------|
| [fuzzystrmatch](/fuzzystrmatch) |  |  |  | [`postgis_tiger_geocoder`](/postgis_tiger_geocoder) |
...
Install `fuzzystrmatch` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add fuzzystrmatch
```


Install `fuzzystrmatch` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
