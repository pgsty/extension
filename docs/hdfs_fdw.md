...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [hdfs_fdw](https://github.com/EnterpriseDB/hdfs_fdw) | 2.0.5 | **<span class="tcblue">BSD-3</span>** | **<span class="tccyan">PGDG</span>** |  |  |
...
Install `hdfs_fdw` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add hdfs_fdw
```


Install `hdfs_fdw` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 |
|:------------:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `hdfs_fdw_17*` | `hdfs_fdw_16*` | `hdfs_fdw_15*` | `hdfs_fdw_14*` | `hdfs_fdw_13*` |
| `el9` | `hdfs_fdw_17*` | `hdfs_fdw_16*` | `hdfs_fdw_15*` | `hdfs_fdw_14*` | `hdfs_fdw_13*` |
| `d12` | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> |
| `u22` | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> |
| `u24` | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> | <span class="tcred">✘</span> |
