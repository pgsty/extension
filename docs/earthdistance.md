...
|-----------|:-------:|:-------:|:---:|:---:|:--:|
| [earthdistance](https://www.postgresql.org/docs/current/earthdistance.html) | 1.1 | **<span class="tcblue">PostgreSQL</span>** | **<span class="tcblue">CONTRIB</span>** | **<span class="tcblue">CONTRIB</span>** | `C` |
...
Install `earthdistance` via the [`pig`](https://github.com/pgsty/pig) cli tool:

```bash
pig ext add earthdistance
```


Install `earthdistance` via [Pigsty](https://pigsty.io/docs/pgext/usage/install/) playbook:
