...
| Distro / Ver | PG17 | PG16 | PG15 | PG14 | PG13 | PG12 |
|:------------:|:----:|:----:|:----:|:----:|:----:|:----:|
| `el8` | `table_log_17` | `table_log_16` | `table_log_15` | `table_log_14` | `table_log_13` | `table_log_12` |
| `el9` | `table_log_17` | `table_log_16` | `table_log_15` | `table_log_14` | `table_log_13` | `table_log_12` |
| `d12` | `postgresql-17-tablelog` | `postgresql-16-tablelog` | `postgresql-15-tablelog` | `postgresql-14-tablelog` | `postgresql-13-tablelog` | `postgresql-12-tablelog` |
| `u22` | `postgresql-17-tablelog` | `postgresql-16-tablelog` | `postgresql-15-tablelog` | `postgresql-14-tablelog` | `postgresql-13-tablelog` | `postgresql-12-tablelog` |
| `u24` | `postgresql-17-tablelog` | `postgresql-16-tablelog` | `postgresql-15-tablelog` | `postgresql-14-tablelog` | `postgresql-13-tablelog` | `postgresql-12-tablelog` |
